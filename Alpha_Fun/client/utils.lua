...
AddEventHandler('esx_pouvoir:closestBGD', function()
    local text = '*La personne trouve Alpha BG *' -- edit here if you want to change the language : EN: the person / FR: la personne
    TriggerServerEvent('3dme:shareDisplay', text)
end)

RegisterNetEvent('esx_pouvoir:closestbg2')
AddEventHandler('esx_pouvoir:closestbg2', function()
    local text = '*La personne tombe sous le charme d Alpha *' -- edit here if you want to change the language : EN: the person / FR: la personne
    TriggerServerEvent('3dme:shareDisplay', text)
end)
...
AddEventHandler('esx_pouvoir:closestbg3', function()
    local text = '*La personne trouve Alpha TROP BG *' -- edit here if you want to change the language : EN: the person / FR: la personne
    TriggerServerEvent('3dme:shareDisplay', text)
end)
